...
import { activateTouristButton, deactivateTouristButton } from "http://127.0.0.1:5501/static/js/map_scripts/menu.js";
...
export let markers = [];
 ...
 async function fetchTouristData(category) {
     try {
         const response = await fetch('http://127.0.0.1:5501/static/data/tourist_data.json');
 ...
 function addMarkers(category, locations) {
    console.log('adding markers...');
     locations.forEach(location => {
         ...
         const iconUrl = isInBucketList ? `http://127.0.0.1:5501/static/img/${category}2.png` : `http://127.0.0.1:5501/static/img/${category}.png`;
