...
#
# data = data.dropna(subset=['centroid_x', 'centroid_y'])
#
# features = []
# for _, row in data.iterrows():
#     feature = geojson.Feature(
#         geometry=geojson.Point((row['centroid_x'], row['centroid_y'])),
#         properties={key: row[key] for key in data.columns if key not in ['centroid_x', 'centroid_y']}
#     )
#     features.append(feature)
#
# feature_collection = geojson.FeatureCollection(features)
#
# geojson_file = "../data/air_quality.geojson"
